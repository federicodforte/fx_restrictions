# Indicador de Complejidad de Restricciones Cambiarias (ICReC)
...
Forte, Federico Daniel (2024). Indicador de Complejidad de Restricciones Cambiarias [Data set]. https://github.com/federicodforte/fx_restrictions
